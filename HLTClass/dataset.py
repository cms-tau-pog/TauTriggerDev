...
class Dataset:
    ...
    def matching_Gentaus(self, L1Taus, Taus, GenTaus, dR_matching_min = 0.5):
        ...
        matching_mask = ak.any(mask_gentaus_l1taus, axis=-1) & ak.any(mask_gentaus_taus, axis=-1)  # Gentau should match l1 and gentau

        return matching_mask

    def matching_L1Taus_obj(self, L1Taus, Obj, dR_matching_min = 0.5):
